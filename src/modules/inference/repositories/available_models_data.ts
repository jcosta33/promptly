    ...
    "Phi 1.5": [
        {
            ...
            short_description:
                "Phi-1.5 is a 1.3B-parameter model that punches above its weight in reasoning ability, exhibiting traits of much larger LLMs. It's an instruction-tuned model suitable for basic tasks.",
        },
        {
    ...
    "Gemma 2": [
        {
            ...
            short_description:
                "Gemma 2 (2B) is a lightweight instruction-tuned model from Google DeepMind's Gemma family. It's designed for efficiency, providing decent performance in a small package.",
        },
        {
        ...
        },
        {
            ...
            short_description:
                "Gemma 2 (9B) is the larger variant in the Gemma 2 family, offering improved accuracy and knowledge. It remains relatively compact while delivering state-of-the-art performance for its size.",
        },
    ],
    ...
    "RedPajama INCITE Chat 3B v1": [
        {
            ...
            short_description:
                "RedPajama-INCITE 3B is an open 3B-parameter chat model fine-tuned on RedPajama data. It outperforms older models of similar size (e.g. GPT-NeoX 2.7B) on many tasks, making it a strong tiny chatbot.",
        },
        {
    ...
    "Mistral 7B v0.3": [
        {
            ...
            tags: ["multilingual", "efficient"],
            short_description:
                "Mistral 7B v0.3 is an improved instruct model that leverages the highly capable Mistral base. It achieves performance on par with larger models like Llama 2 13B on many benchmarks, in a 7B form factor.",
        },
        {
    ...
    "Qwen 2": [
        {
            ...
            tags: ["compact", "multilingual"],
            short_description:
                "A tiny 500M-parameter Qwen 2 instruct model. Despite its size, it's trained on diverse text and code, making it useful for simple tasks with minimal resources.",
        },
        {
